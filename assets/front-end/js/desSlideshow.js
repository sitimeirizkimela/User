...
(function(a){
    a.fn.desSlideshow=function(p){
        ...
        var slideshow_width=p&&p.slideshow_width?p.slideshow_width:"613";
        var slideshow_height=p&&p.slideshow_height?p.slideshow_height:"317";
        ...
        function init(){
            ...
            g.find("img").css("border","none").css("width","613px");
            g.find("ul").css("margin","0px").css("padding","0px").css("padding-top","60px");
            ...
            g.find(".switchBigPic").children("div").children("p").css("position","absolute").css("display","block").
			css("padding","5px").
			css("margin","0px").css("bottom","30px").css("opacity","0.6").
			css("font-size","12px").css("color","#ffffff").css("width","300px").css("right","0px");
            g.find(".nav").css("width",thumbnail_width+"px").css("height",slideshow_height+"px").css("position","absolute").css("left","0px");
            g.find(".nav").children("li").css("height","49px").css("background-image","url("+directory+"slide-bg-kanal.png)").css("line-height","49px").css("border-bottom","1px solid #CCCCCC").css("border-right","1px solid #CCCCCC");
        ...
        function showpic(){
            clearTimeout(v);
            g.find(".nav").children("li").css("background-image","url("+directory+"slide-bg-kanal.png)").css("border-bottom","1px solid #CCCCCC");
            ...
            g.find(".nav").children("li").eq(current).animate({marginRight: '-35px'}, "fast");
            g.find(".nav").children("li").eq(w).animate({marginRight: '0px'}, "fast");
            w = current;
